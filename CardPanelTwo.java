...
public class CardPanelTwo extends JPanel {
    ...
    public CardPanelTwo(int n) {
        if (n == 1) {
            add(new Card("/Users/ali/Main/Documents/Source/Amusement-Park/src/image/cannon.png",
            ...
            add(new Card("/Users/ali/Main/Documents/Source/Amusement-Park/src/image/waterPark.png",
            ...
            add(new Card("/Users/ali/Main/Documents/Source/Amusement-Park/src/image/swinging.png",
            ...
            add(new Card("/Users/ali/Main/Documents/Source/Amusement-Park/src/image/funfar.png",
            ...
            add(new Card("/Users/ali/Main/Documents/Source/Amusement-Park/src/image/train.png",
